...
// URL Rewriting Function - .htaccess alternatifi
function handleCleanURLs() {
    ...
    const urlMap = {
        ...
        '/hizmetlerimiz': 'hizmetlerimiz.html',
        '/yayinlarim': 'yayinlarim.html',
        '/iletisim': 'iletisim.html',
        '/hizmetler/mide-kanseri': 'hizmetler/mide-kanseri.html',
        '/hizmetler/kalin-bagirsak-kanseri': 'hizmetler/kalin-bagirsak-kanseri.html',
        '/hizmetler/ozofagus-kanseri': 'hizmetler/ozofagus-kanseri.html',
        '/hizmetler/pipac-tedavisi': 'hizmetler/pipac-tedavisi.html',
        '/hizmetler/pelvik-egzenterasyon': 'hizmetler/pelvik-egzenterasyon.html',
        '/hizmetler/cerrahi-onkoloji': 'hizmetler/cerrahi-onkoloji.html',
        '/hizmetler/gastrointestinal-cerrahi': 'hizmetler/gastrointestinal-cerrahi.html',
        '/hizmetler/hipec': 'hizmetler/hipec.html',
        '/hizmetler/laparoskopik-cerrahi': 'hizmetler/laparoskopik-cerrahi.html'
    };
    
    // Eğer mevcut path listede varsa, ilgili HTML dosyasını yükle
    if (urlMap[currentPath]) {
        // Sayfa yüklenmeden önce loading göster
        showPageLoading();
        
        // HTML dosyasını fetch ile yükle
        fetch(urlMap[currentPath])
            .then(response => {
                if (!response.ok) {
            ...
            .then(html => {
                ...
                // Sadece body içeriğini güncelle
                document.body.innerHTML = doc.body.innerHTML;
                
                // Script'leri yeniden yükle
                loadScripts();
                
                // URL'yi güncelle (browser history'de)
                window.history.pushState({}, '', currentPath);
                
                // Loading'i gizle
                hidePageLoading();
                
                // Sayfa yüklendikten sonra event listener'ları yeniden ekle
                setTimeout(() => {
...
function loadScripts() {
    // Bootstrap'i yeniden yükle
    if (typeof bootstrap !== 'undefined') {
        // Bootstrap tooltip'leri yeniden initialize et
...
function initializeEventListeners() {
    // Mobile menu functionality'yi yeniden initialize et
    initializeMobileMenu();
    // Dropdown'ları yeniden initialize et
    initializeDropdowns();
}
...
// Sayfa yüklendiğinde URL rewriting'i başlat
